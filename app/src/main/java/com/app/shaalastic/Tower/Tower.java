...
public class Tower extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView=(RecyclerView) view.findViewById(R.id.towerRecycler);
        ArrayList<TowerData> data=new ArrayList<>();
        data.add(new TowerData("Tower 1"));
        data.add(new TowerData("Tower 2"));
        data.add(new TowerData("Tower 3"));
        data.add(new TowerData("Tower 4"));
        recyclerView.setAdapter(new TowerAdapter(getActivity(),data));
